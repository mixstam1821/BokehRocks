from bokeh_rocks import jk9, build_auto_tooltip, hovfun, add_extras, save_plot, cusj, apply_theme
import pandas as pd
import numpy as np
...
apply_theme(p,'light');add_extras(p,cross=1); show(p);fname = "output/line_01"; save_plot(p,fname)
