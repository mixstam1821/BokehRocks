...
from bokeh.models import ColumnDataSource, ColorBar, LinearColorMapper, Legend, LegendItem, Circle, Scatter
import numpy as np
...
p = figure(title="Scatter Plot with Magma Palette, Colorbar, and Size Legend",
           x_axis_label="X-axis", y_axis_label="Y-axis",
           width=1350, height=800,**jk9)
...
p2 = figure(width=105, height=250,**jk9, x_range=(-0.8,2), y_range=(-3,40),styles = {'margin-top': '300px','margin-left': '-110px'})
x_text = [0]*4
x2_text = [1.4]*4
